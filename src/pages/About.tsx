  ...
  return (
    <Layout>
      ...
      <section className="pt-32 pb-16 bg-industry-50">
        <div className="container mx-auto px-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-industry-900 mb-6" data-aos="fade-up">About Shyama Ventures</h1>
            <p className="text-lg text-industry-700 mb-8" data-aos="fade-up" data-aos-delay="100">
                Shyama Ventures is a bold, innovative startup on a mission to transform the future of smart manufacturing and sustainable tech. 
    ...
    <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
            ...
            <div className="">
                ...
                Shyama Ventures was born out of a shared vision: to rethink how modern industries access smart, sustainable, and reliable manufacturing solutions. Founded in 2023 by a team of engineers and innovators, we set out to bridge the gap between traditional manufacturing and future-forward technologies.
                </p>
                <p className="text-industry-700 mb-4">
    ...
    <section className="py-16 bg-industry-900 text-white text-center">
        <div className="container mx-auto px-4">
            ...
            <p className="text-lg mb-6">Join hundreds of clients who trust Shyama Ventures for quality and reliability.</p>
            <Link to="/contact">
